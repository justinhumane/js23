  ...
  <div class="view-body">
    ...
    <div class="home-text">
      ...
      <p>
        ...
        lacinia. Aenean fermentum risus id tortor. Nullam lectus justo,
        vulputate eget mollis sed, tempor sed magna. Nullam rhoncus aliquam
        metus. Integer tempor. Neque porro quisquam est, qui dolorem ipsum quia
        dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius
        modi tempora incidunt ut labore et dolore magnam aliquam quaerat
        voluptatem. Integer tempor. Quisque tincidunt scelerisque libero. Nullam
        lectus justo, vulputate eget mollis sed, tempor sed magna. Suspendisse
        nisl. Maecenas lorem. Integer in sapien.
      </p>
